...
let eneCnt=5;
let eneCntMax=[5,5,3,5,4,7,1,5,2,4];
...
alert("このゲームはクリックRPGです。");
 ...
 alert("強撃は自分のMPを5消費して、相手に自分の攻撃力の5倍のダメージを与えますが、自分の攻撃力の2分の1のダメージを受けます。");
 alert("MPはモンスターに攻撃することで1回復します。");
 alert("強撃では大きなダメージを与えられますが、モンスターにトドメはさせません。HPが0以下になったらモンスターをクリックしてトドメを刺しましょう。");
 alert("モンスターを倒すと経験値が手に入り、レベルが上がります。上限はレベル10です。");
